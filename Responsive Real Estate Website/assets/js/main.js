...
function scrollHeader() {
    ...
    // When the scroll is greater than 50 vwh, add the 
    if (this.scrollY >= 50) {
...
if (selectedTheme) {
    ...
    // classList.add သည် classList[add] နဲ့တူတူပဲ. Object တွေမို့လို့!
}
...
scr.reveal(`.home__description, .footer__info`, { delay: 500 })
scr.reveal(`.home__search`, { delay: 600 })
scr.reveal(`.home__value`, { delay: 700 })
scr.reveal(`.home__img`, { delay: 800, origin: 'bottom' })

scr.reveal(`.logos__img`, { interval: 500 })
